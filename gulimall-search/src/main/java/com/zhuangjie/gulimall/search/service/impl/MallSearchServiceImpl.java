...
import com.zhuangjie.gulimall.search.constant.EsConstant;
import com.zhuangjie.gulimall.search.feign.ProductFeignService;
import com.zhuangjie.gulimall.search.service.MallSearchService;
import com.zhuangjie.gulimall.search.vo.AttrResponseVo;
import com.zhuangjie.gulimall.search.vo.BrandVo;
...
//            attrs=2_5存:6寸
                ...
                if(r.getCode() == 0){
                    ...
                    AttrResponseVo data = (AttrResponseVo) r.getData("attr",typeReference);
