...
import com.zhuangjie.gulimall.product.vo.SeckillInfoVo;
import com.zhuangjie.gulimall.product.vo.SkuItemSaleAttrVo;
import com.zhuangjie.gulimall.product.vo.SkuItemVo;
...
import com.zhuangjie.gulimall.product.dao.SkuInfoDao;
...
public class SkuInfoServiceImpl extends ServiceImpl<SkuInfoDao, SkuInfoEntity> implements SkuInfoService {
    ...
    @Autowired
    private SpuInfoService spuInfoDescService;
    ...
    public SkuItemVo item(Long skuId) throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<Void> descFuture = infoFuture.thenAcceptAsync(res -> {
            ...
            SpuInfoEntity spuInfoEntity = spuInfoDescService.getById(res.getSpuId());
            // 将 SpuInfoEntity 转为 SpuInfoDescEntity
